...
def get_sysconfigdata_files(environ):
    ...
    from os import path
    dist = path.join(environ.get("PWD"), path.abspath(path.join('.',  # Python-3.4.1
...
def fix_linker_rpath(path):
    ...
    # python/lib/python3.4/site-packages/<package-root>/<package-src>
    # (e.g. python/lib/python3.4/site-packages/lxml-3.4.1-py3.4-linux-i686.egg/lxml)
